...
export function WhatsAppButton() {
  ...
  return (
    <AnimatePresence>
      {visible && (
        <motion.div
          className="fixed bottom-84 right-4 sm:bottom-84 sm:right-6 lg:right-24 z-40"
        ...
        >
          <div className="relative">
            ...
            <motion.a
              ...
              className="flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-[#25D366] to-[#128C7E] shadow-lg shadow-[#25D366]/40 border-2 border-white/15 hover:shadow-[0_0_30px_rgba(37,211,102,0.5)] transition-shadow"
